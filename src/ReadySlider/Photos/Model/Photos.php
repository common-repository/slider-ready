...
/**
 * Class ReadySlider_Photos_Model_Photo
 *
 * @package ReadySlider\Photos\Model
 * @author Artur Kovalevsky
 */
class ReadySlider_Photos_Model_Photos extends Rsc_Mvc_Model implements Rsc_Environment_AwareInterface
{
     ...
     * @return ReadySlider_Photos_Model_Photos
     */
    ...
    public function getFolderByPhotoId($photoId)
    {
        ...
        if (!class_exists($classname = 'ReadySlider_Photos_Model_Folders', false)) {
        ...
        $folders = new ReadySlider_Photos_Model_Folders($this->debugEnabled);
    ...
    {
//        $resources = new ReadySlider_Galleries_Model_Resources();
//
...
//        if ($this->environment) {
//            /** @var ReadySlider_Photos_Module $photos */
