...
/**
 * Class ReadySlider_Photos_Model_Settings
 ...
 */
class ReadySlider_Photos_Model_Settings extends Rsc_Mvc_Model
{
    ...
    public function __construct($debugEnabled = false)
    {
        ...
        $this->table = $this->db->prefix . 'rs_photos_settings';
     ...
     * @return ReadySlider_Photos_Model_Settings
     */
