...
/**
 * Class ReadySlider_Colorbox_Module.
 * Registers the Colorbox in the system.
 * @package ReadySlider\Colorbox
 */
class ReadySlider_Colorbox_Module extends Rsc_Mvc_Module
{
     ...
     * @param ReadySlider_Ui_Module $ui The UI Module.
     */
    public function load(ReadySlider_Ui_Module $ui)
    {
        $this->loadPlugin($ui);
        $this->loadLocale($ui);
        $this->loadTheme($ui);
    ...
    public function reload()
    {
        ...
        if (is_object($ui) && $ui instanceof ReadySlider_Ui_Module) {
            $this->load($ui);
     ...
     * @param ReadySlider_Ui_Module $ui The UI Module.
     */
    protected function loadPlugin(ReadySlider_Ui_Module $ui)
    {
        $ui->add(
        ...
        $frontend = new ReadySlider_Ui_Javascript(
     ...
     * @param ReadySlider_Ui_Module $ui The UI Module.
     */
    protected function loadLocale(ReadySlider_Ui_Module $ui)
    {
        $locale = get_locale();
     ...
     * @param ReadySlider_Ui_Module $ui The UI Module.
     */
    protected function loadTheme(ReadySlider_Ui_Module $ui)
    {
        $config = $this->getEnvironment()->getConfig();
